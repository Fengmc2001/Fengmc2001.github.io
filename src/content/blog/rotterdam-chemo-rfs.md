...
**[三言語HTMLスライドを開く](https://fengmc2001.github.io/rotterdam-chemo-rfs/slides/)** — 原稿を再構成した公開学習版。表紙の所属・試験・個人情報は含めていません。原PDFの逐頁複製ではありません。
...
- 公開用の解説文では、パーセントポイントと因果推論の仮定を明確化しています。すべてのスライドを逐語的に再掲載したものではありません。元のスライドには所属機関の発表資料や講義に由来する内容も含まれるため、再配布していません。
