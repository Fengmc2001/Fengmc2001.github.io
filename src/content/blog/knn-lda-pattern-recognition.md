...
badge: "Academic"
tags: ["machine-learning", "pattern-recognition", "classification", "lda", "knn"]
---
...
2. クラスタリングアルゴリズムを併用し、クラスタ内誤差平方和（SSE）とクラスタ数 $K$ の関係を評価する。SSEの減少率が緩やかになる点（エルボー法）を見つけ、最適なクラスタ数として採用することで、データ分布の変動に対してより柔軟に対応できる。
